...
<details>
<summary><b>🤖 Emotion Detection System</b></summary>
<br />

Implemented a CNN-based model achieving 90% accuracy for emotion classification (happy, sad, anger, etc.)across 300+ images, reducing manual analysis time by 20%.

| Stack | Scale | Performance | Security | Impact | Repository |
| :--- | :--- | :--- | :--- | :--- | :--- |
| Python, ML, NLP | Academic Project | High F1-Score | Data Privacy | Enables real-time sentiment analysis to enhance human-computer interaction (HCI). | [View Repository](#) |
...
<div align="center">
 ...
 <img height="169em" src="https://streak-stats.demolab.com/?user=rahulroy-developer&theme=radical&v=2" alt="Streak Stats" />
  &nbsp;
